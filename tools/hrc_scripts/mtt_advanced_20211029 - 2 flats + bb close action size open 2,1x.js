...
let SIZES_OPEN_OTHERS = [2.1, ALLIN];
let SIZES_OPEN_BU = [2.1, ALLIN];
let SIZES_OPEN_SB = [3.0, ALLIN];
let SIZES_OPEN_BB = [3.5, ALLIN];

//general 3-bet sizing in big blinds
let SIZES_3BET_IP = [6, ALLIN];
let SIZES_3BET_BB_VS_SB = [8, ALLIN];
let SIZES_3BET_BB_VS_OTHER = [8.5, ALLIN];
let SIZES_3BET_SB_VS_BB = [8, ALLIN];
let SIZES_3BET_SB_VS_OTHER = [8.0, ALLIN];

//special sizing for squeezes in big blinds
let SIZES_3BET_SQUEEZE_IP = [8.2, ALLIN];
let SIZES_3BET_SQUEEZE_SB = [8.5, ALLIN];
let SIZES_3BET_SQUEEZE_BB = [10.5, ALLIN];
let SQUEEZE_INCREASE_PER_CALL = 2.0; //added to squeeze size for multiple callers

//general 4-bet rules, sized in relation to pot
let SIZES_POT_4BET_IP = [0.45, ALLIN];
let SIZES_POT_4BET_OOP = [0.55, 0.99, ALLIN];
...
//Whether to allow cold calls of 5+ bets
...
let POSTFLOP_ALLOW_DONK = true; //Whether to allow all donk bets
