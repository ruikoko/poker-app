...
let SIZES_OPEN_OTHERS = [2.2, ALLIN];
let SIZES_OPEN_BU = [2.2, ALLIN];
let SIZES_OPEN_SB = [3.5, ALLIN];
let SIZES_OPEN_BB = [3.5, ALLIN];

//general 3-bet sizing in big blinds
let SIZES_3BET_IP = [5.9, 6.5, ALLIN];
let SIZES_3BET_BB_VS_SB = [8.5, ALLIN];
let SIZES_3BET_BB_VS_OTHER = [7.0, ALLIN];
let SIZES_3BET_SB_VS_BB = [9.2, ALLIN];
let SIZES_3BET_SB_VS_OTHER = [8.5, ALLIN];

//special sizing for squeezes in big blinds
let SIZES_3BET_SQUEEZE_IP = [9.2, ALLIN];
let SIZES_3BET_SQUEEZE_SB = [10.0, ALLIN];
let SIZES_3BET_SQUEEZE_BB = [7.0, ALLIN];
let SQUEEZE_INCREASE_PER_CALL = 2.0; //added to squeeze size for multiple callers

//general 4-bet rules, sized in relation to pot
let SIZES_POT_4BET_IP = [0.4, ALLIN];
let SIZES_POT_4BET_OOP = [0.5, ALLIN];
