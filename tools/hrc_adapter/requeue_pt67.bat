...
REM
REM  FLUXO regra 4 (canal unico): descarrega o requeue_state.py da Release
REM  watcher-pt67 e corre-o pela venv do adapter. Zero transferencias manuais,
REM  zero edicao de JSON a mao.
REM
...
REM
REM  PRE-REQUISITO (lado backend, feito pelo Code via Railway): apagar as 2
REM  linhas de hrc_jobs (GG-6029013400 + GG-6039094225) -> ja feito.
REM
REM  ASCII puro + CRLF (pt67 fix: a versao anterior tinha LF + acentos e o cmd
REM  rebentava). Correr no BEELINK. Duplo-clique. Precisa de internet.
REM ============================================================
setlocal
