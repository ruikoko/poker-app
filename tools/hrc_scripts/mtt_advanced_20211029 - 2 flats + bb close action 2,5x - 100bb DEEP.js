...
let SIZES_OPEN_OTHERS = [2.5];
let SIZES_OPEN_BU = [2.5];
let SIZES_OPEN_SB = [3.5];
let SIZES_OPEN_BB = [3.5];

//general 3-bet sizing in big blinds
let SIZES_3BET_IP = [10.75];
let SIZES_3BET_BB_VS_SB = [11.5];
let SIZES_3BET_BB_VS_OTHER = [12.5];
let SIZES_3BET_SB_VS_BB = [12];
let SIZES_3BET_SB_VS_OTHER = [11.5];

//special sizing for squeezes in big blinds
let SIZES_3BET_SQUEEZE_IP = [12.5, ALLIN];
let SIZES_3BET_SQUEEZE_SB = [13.65, ALLIN];
let SIZES_3BET_SQUEEZE_BB = [13.65, ALLIN];
...
let SIZES_POT_4BET_OOP = [0.6, ALLIN];
