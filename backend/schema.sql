...
CREATE TABLE IF NOT EXISTS hands (
    ...
    tournament_format TEXT,                       -- 'PKO' | 'KO' | 'mystery' | 'vanilla' (NULL se não classificado)
...
CREATE INDEX IF NOT EXISTS idx_hands_tournament_format ON hands(tournament_format);
