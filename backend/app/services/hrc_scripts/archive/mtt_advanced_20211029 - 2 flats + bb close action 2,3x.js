...
let SIZES_3BET_BB_VS_OTHER = [10.5];
let SIZES_3BET_SB_VS_BB = [12];
let SIZES_3BET_SB_VS_OTHER = [10.5];

//special sizing for squeezes in big blinds
let SIZES_3BET_SQUEEZE_IP = [11.5];
let SIZES_3BET_SQUEEZE_SB = [11.65];
let SIZES_3BET_SQUEEZE_BB = [11.65];
