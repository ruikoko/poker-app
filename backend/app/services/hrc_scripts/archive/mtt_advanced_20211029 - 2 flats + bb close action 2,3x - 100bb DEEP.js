...
let SIZES_3BET_IP = [8.05];
let SIZES_3BET_BB_VS_SB = [10.5];
let SIZES_3BET_BB_VS_OTHER = [11.5];
let SIZES_3BET_SB_VS_BB = [12];
let SIZES_3BET_SB_VS_OTHER = [11.5];

//special sizing for squeezes in big blinds
let SIZES_3BET_SQUEEZE_IP = [11.5, ALLIN];
let SIZES_3BET_SQUEEZE_SB = [12.65, ALLIN];
let SIZES_3BET_SQUEEZE_BB = [12.65, ALLIN];
